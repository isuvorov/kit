...
### № 1.40 Поле password. Проверить граничные значения, max/min кол-во символов в пароле(8-100). Ввести в поле password 7, 101 символов
...
### № 1.41 Поле password. Проверить граничные значения, max/min кол-во символов в пароле(8-100). Ввести в поле password 8, 9, 50, 99, 100 символов
...
### № 4.2 Залогинитсься в систему через кнопку "Continue with Google"
...
### № 4.3 Залогинитсься в систему через кнопку "Continue with Google" юзером которого нет в базе
...
### № 4.4 Залогинитсься в систему через кнопку "Continue with Google" юзер есть в базе
...
### № 4.7 Оба поля "Email" и "Password" пустые

1. Нажать кнопку "Log In"

**Ожидаемый результат:** появление сообщений "Email cannot be black", "Password cannot be black"

### № 4.8 Ввод некорректного email в поле login

1. Ввести некорректный email 123@123.123
2. Заполнить поле "Password"
3. Нажать кнопку "Log In"

**Ожидаемый результат:** появление сообщения "Incorrect email or password"

### № 4.9 Вввод некорректного пароля в поле password
...
### № 4.10 Ввести неккоректный email и пароль
...
### № 4.11 Ввести email uppercase/camelcase/разные регистры 
...
### № 4.12 Вставить пробел перед email
...
### № 4.13 Ввод скриптов/sql иньекций в поля login и password
...
### № 4.14 Просмотр пароля. Проверить что пароль скрыт по дефолту
...
### № 4.15 Проверка перехода на страницу Sign Up
...
### № 4.16 Проверка перехода на страницу Forgot Password
...
### № 4.17 Проверка сессии. Залогиниться в систему, закрыть браузер, открыть браузер, проверить что сессия не "протухла"
...
### № 4.18 Проверить верстку страницы в браузерах Chrome, Firefox, Safari
...
### № 4.19 Проверить адоптацию страницы под разные разрешения экрана(а также мобильные устройства)
